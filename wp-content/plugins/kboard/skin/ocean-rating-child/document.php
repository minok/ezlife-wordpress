	...
	<div class="kboard-document-wrap" itemscope itemtype="http://schema.org/Article">
		...
		<div class="kboard-content" itemprop="description">
			<div class="content-view">
				...
				<p class="like-area">
					<a href="#" onclick="return kboard_ocean_rating_like('<?php echo $content->uid?>')"; class="kboard-item-like">추천 : <span class="kboard-count-bold"><?php echo $content->like?></span></a>
				</p>
			</div>
		</div>
	</div>
